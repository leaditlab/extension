...
(function (global, factory) {
  ...
  function getClippingParents(element) {
    ...
    return clippingParents.filter(function (clippingParent) {
      return (
        isElement$1(clippingParent) && contains(clippingParent, clipperElement)
      );
    });
  ...
  function makeCenteredPopper(step) {
    ...
    popperOptions = _extends({}, popperOptions, {
      modifiers: Array.from(
        new Set([].concat(popperOptions.modifiers, centeredStylePopperModifier))
      ),
    });
    ...
    if (step.options.popperOptions) {
      if (
        ...
        popperOptions.modifiers = Array.from(
          new Set(
            [].concat(filteredModifiers, step.options.popperOptions.modifiers)
          )
        );
      }
  ...
  function instance$7($$self, $$props, $$invalidate) {
    ...
    onMount(function () {
      ...
      $$invalidate(
        ...
        (dataStepId =
          ((_dataStepId = {}),
          (_dataStepId["data-" + classPrefix + "shepherd-step-id"] = step.id),
          _dataStepId))
      );
      $$invalidate(
        9,
  ...
  var Step = /*#__PURE__*/ (function (_Evented) {
    ...
    function Step(tour, options) {
      ...
      _this.tour = tour;
      _this.classPrefix = _this.tour.options
        ? normalizePrefix(_this.tour.options.classPrefix)
        : "";
    ...
    _proto._styleTargetElementForStep = function _styleTargetElementForStep(
      step
    ) {
